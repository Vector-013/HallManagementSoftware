...
admin.site.register(MessEmployee)
admin.site.register(MessManager)
admin.site.register(Amenities)
admin.site.register(HallPassbook)
admin.site.register(MessPassbook)
admin.site.register(HallTransaction)
admin.site.register(MessTransaction)
admin.site.register(Ration)
admin.site.register(Menu)
admin.site.register(Warden)
admin.site.register(WardenPassbook)
admin.site.register(WardenTransaction)
